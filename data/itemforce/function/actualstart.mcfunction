...
summon minecraft:item_display 0 -63 0 {Tags:["team_item","team_item_1"],data:{"team":"1"}}
summon minecraft:item_display 0 -63 0 {Tags:["team_item","team_item_2"],data:{"team":"2"}}
